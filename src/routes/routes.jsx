...
import Settings, { AuthorizedSignatureChallan, AuthorizedSignatureInvoice, BankAccountSettingChallan, BankAccountSettingInvoicentact, PrefixSettingChallan, PrefixSettingInvoice, ThemeSettingChallan, ThemeSettingInvoice } from "../pages/Settings";
    ...
    return (
        <Router>
            ...
            <Routes>
                ...
                <Route path="/quotation" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<QuotationTable/>} />} />
                ...
                <Route path="/invoice-preview" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<InvoicePreview />} />} />
                <Route path="/invoice-edit" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<InvoiceEdit />} />} />
                <Route path="/generate-challan" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<GenerateChallan />} />} />
                <Route path="/invoiceSampleA4" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<InvoiceSampleA4 />} />} />
                <Route path="/purchaseForm" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<PurchaseForm />} />} />
                ...
                <Route path="/paymentOut" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<PaymentOut />} />} />
                <Route path="/users" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<Users />} />} />
                <Route path="/userForm" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<UserForm />} />} />
                <Route path="/settings/prefixInvoice" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<PrefixSettingInvoice/>} />} />
                <Route path="/settings/prefixChallan" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<PrefixSettingChallan/>} />} />
                <Route path="/settings/themeInvoice" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<ThemeSettingInvoice/>} />} />
                <Route path="/settings/themeChallan" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<ThemeSettingChallan/>} />} />
                <Route path="/settings/bankAccountInvoice" element={<ProtectedRoute isAuthenticated={isAuthenticated} element={<BankAccountSettingInvoicentact/>} />} />
