                ...
                <div className="bg-white border border-orange-500 rounded-lg p-4">
                  ...
                  <div className="overflow-x-auto">
                    <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 text-center font-poppins font-medium text-gray-700 border-gray-300 border-t py-4 min-w-[500px]">
                      <span className='border-r font-semibold p-1'>Mess Name</span>
                      ...
                      {/* <span className='font-semibold p-1'>Mess Name</span> */}

                      <span className='border-r text-[#3C3C4399] p-1'>{order.messName}</span>
                      ...
                      {/* <span className=' text-[#3C3C4399] p-1'>{order.messName}</span> */}
                    </div>
                  </div>
