...
export function Quotation_edit() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      values.cgstAmount =
        gstAmount != null ? gstAmount / 2 : quotationData.cgst;
      values.sgstAmount =
        gstAmount != null ? gstAmount / 2 : quotationData.sgst;
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div className="p-1">
                <div className="grid grid-cols-4 gap-4 border border-gray-300 pt-4">
                  ...
                  >
                    Total Amount:₹
                    {addTotal == null ? quotationData.total_amount : addTotal}
                  </div>
                </div>
              </div>
                ...
                <div>
                  <div className="border p-6 h-60 bg-gray-50 text-gray-500 text-lg font-medium cursor-pointer">
                    ...
                    <div className="mt-1 p-2">
                      ...
                      <p className="text-sm">
                        Account Holder's Name: {quotationData.accountholder}
                      </p>
                      <p className="text-sm">
                        IFSC CODE: {quotationData.bankifsc}
                      </p>
                      <p className="text-sm">
                        Branch Name: {quotationData.bankbranch}
                      </p>
                    </div>
                    {/* <ButtonComponent
                  type="button"
