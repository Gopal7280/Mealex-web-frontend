...
export function Quotation_edit() {
  ...
  const challanData = quotationPreview[0];
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      values.quotationPrefix = challanData.quotation_prefix;
      values.quotationId = challanData.quotation_id;
      ...
      if (values.customerName == "") {
        values.customerName = quotationPreview[0].customername;
      }
      if (values.billing_address == "") {
        values.billing_address = quotationPreview[0].billingaddress;
      }
      if (values.shipping_address == "") {
        values.shipping_address = quotationPreview[0].shippingaddress;
      }
      ...
      if (values.challanNotes == "") {
        values.challanNotes = quotationPreview[0].add_notes;
      }
              ...
              <div className="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
                <div>
                  <InputComponent
                    ...
                    labelInput="Sales Quotation Date:"
                    ...
                    {...(isEditable
                      ? {}
                      : { value: challanData.sales_quotation_date })} // Use optional chaining)}
                    required
                ...
                <div>
                  <InputComponent
                    ...
                    {...(isEditable
                      ? {}
                      : { value: challanData.quotation_prefix })} // Use optional chaining)}
                    required
                    classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                  />
                </div>
                ...
                {/* <div>
                  <InputComponent
                    ...
                    required
                    onFocus={handleEditable}
                    {...(isEditable?{}:{value:challanData.mobile_no})} // Use optional chaining)}
                    classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                  />
                </div> */}
                <div>
                  <InputComponent
                    ...
                    {...(isEditable ? {} : { value: challanData.customername })} // Use optional chaining)}
                    type="text"
                    name="customerName"
              ...
              <div className="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
                <div>
                  <InputComponent
                    ...
                    onChange={formik.handleChange}
                    readOnly
                    value={addTotal == null ? challanData.sgst : gstAmount / 2}
                    classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                  />
                </div>
                <div>
                  <InputComponent
                    ...
                    onChange={formik.handleChange}
                    readOnly
                    value={addTotal == null ? challanData.cgst : gstAmount / 2}
                    classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                  />
                </div>
                <div>
