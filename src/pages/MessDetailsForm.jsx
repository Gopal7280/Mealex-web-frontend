...
//     if (res.data.success) {
//       const { email, requestId, messId, messName } = res.data;
...
//   } catch (err) {
//     console.error(err);
//     alert(err?.response?.data?.message || "Mess registration failed.");
//   } finally {
//     setLoading(false);
//   }
// };
...
//     <TimePicker
//       onChange={(value) => setForm((prev) => ({ ...prev, openTime: value }))}
//       value={form.openTime}
//       disableClock={false}  // true -> sirf input, false -> clock bhi dikhayega
//       clearIcon={null}      // ❌ clear (X) icon hata dega
//       clockIcon={<Clock className="text-orange-500 w-5 h-5" />} // custom clock icon
//       className="w-full px-4 py-3 bg-gray-100 border border-black rounded-xl"
//       required
//     />
//   </div>
...
//   <div className="relative w-full">
//     <TimePicker
//       onChange={(value) => setForm((prev) => ({ ...prev, closeTime: value }))}
//       value={form.closeTime}
//       disableClock={false}
//       clearIcon={null}
//       clockIcon={<Clock className="text-orange-500 w-5 h-5" />}
//       className="w-full px-4 py-3 bg-gray-100 border border-black rounded-xl"
//       required
//     />
//   </div>
...
//               selectedDays.includes(day) ? 'bg-orange-500 text-white' : 'bg-gray-100'
//             }`}
//           >
//             {day}
//           </button>
...
//   type="submit"
//   disabled={loading}
//   className={`w-1/3 font-semibold py-3 rounded-xl transition 
//     ${loading 
