...
//       const id = location.state?.data[0]?.invoice_id; // Use optional chaining
//       console.log(number);
//       console.log(id);
//       console.log(location.state.data);
//       setData([location.state.data[0]]);

//       const fetchProductInvoice = async () => {
...
//   const invoiceId=location.state?.invoice_id;
//   console.log(invoiceId);
//   console.log(invoiceId);
//       //   alert(JSON.stringify(invoiceId));
//       navigate("/invoice-edit", { state: { data: location.state?.data[0] } });
//   }
...
//     // Add page number
//     pdf.setFontSize(10);
//     pdf.text(`${page + 1}/${totalPages}-${data[0].invoice_prefix}`, pageWidth / 2, pageHeight - 5, {
//       align: "center",
//     });
...
//           <div className="bg-white rounded-lg shadow-xl p-6 sm:p-8 w-full max-w-4xl mb-12">
...
//                         {data[0].business_name.substring(0, 1).toUpperCase()}
//                       </h1>
//                     </>
//                   )}
//                 </div>
...
//                     ™
//                   </h3>
//                   {/* <p className="text-sm text-slate-600">{invoiceData.from.address}, {invoiceData.from.city} - {invoiceData.from.zip}</p> */}
//                   <p className="!text-sm !text-[#314158]">
//                     GSTIN: {bussinessData[0].vendor_gstin} | Email:{" "}
//                     {bussinessData[0].vendor_email} | Phone:{" "}
...
//                   INVOICE #{data[0].invoice_prefix}
//                 </h4>
//                 <p className="text-sm text-[#314158]">Date: {date}</p>
//                 <p className="text-sm text-[#314158]">
//                   Due: {data[0].due_date}
//                 </p>
//               </div>
...
//             {/* Bill To Section */}
//             <div className=" p-4 border border-[#cad5e2] rounded-md mb-8">
...
//                 <thead>
//                   <tr className="border-[#cad5e2] text-left text-sm font-semibold text-[#314158]">
...
//                 <div className="flex justify-between py-2 px-4 border-b border-[#e2e8f0]">
//                   <span className="text-[#314158]text-sm">Subtotal:</span>
//                   <span className="font-semibold text-[#314158] text-sm">
//                     ₹ {data[0].taxable_amount}
//                   </span>
//                 </div>
//                 <div className="flex justify-between py-2 px-4 border-b border-[#e2e8f0]">
...
//                   </span>
//                 </div>
//                 <div className="flex justify-between py-3 px-4 bg-[#20B2AA] text-white rounded-b-md">
...
//               <div>
//                 <h4 className="font-semibold text-[#314158] mb-2 text-md">
//                   Bank Transfer Details:
//                 </h4>
//                 <p className="text-sm text-[#314158]">
//                   Bank Name: {data[0].bankbranch}
//                 </p>
//                 <p className="text-sm text-[#314158]">
//                   Account No: {data[0].accountnumber}
//                 </p>
//                 <p className="text-sm text-[#314158]">
//                   Account Holder Name: {data[0].accountholder}
//                 </p>
//                 <p className="text-sm text-[#314158]">
//                   IFSC Code: {data[0].bankifsc}
//                 </p>
//               </div>
//               <div>
//                 {data[0].add_notes != "" ? (
...
//                       <div className="font-serif text-lg text-invoice-signature mb-2">
//                       <div
//                         className="border ml-[50%] border-b-black"
//                         style={{ width: "200px", height: "100px" }}
//                       ></div>
//                       Authorized Signature
//                     </div>
...
//     terms: 'Payment is due within 30 days of the invoice date. Late payments may incur a 2% monthly interest charge.',
//   };
//   useEffect(() => {
//     try {
//       const dt = new Date();
...
//             <div className="p-4" ref={contentRef}>
//             {/* Header Section */}
//             <p className="!text-sm !text-[45556c]">From:</p>
//             <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8">
//       <div className="flex">
//         <div className="m-auto">
//                   {data[0].logo != null ? (
...
//                 </div>
//                 <div>
//         <h3 className="text-xl font-semibold text-[#1d293d]">{bussinessData[0].vendor_business_legal_name.toUpperCase()}</h3>
//         <p className="text-sm text-[#45556c]">{invoiceData.from.address}</p>
//         {/* <p className="text-sm text-slate-600">{invoiceData.from.city} - {invoiceData.from.zip}</p> */}
//         <p className="text-sm text-[#45556c]">{bussinessData[0].vendor_gstin==""?"":"GSTIN" +":" + bussinessData[0].vendor_gstin}</p>
//         <p className="text-sm text-[#45556c]">Email: {bussinessData[0].vendor_email}</p>
//         <p className="text-sm text-[#45556c]">Phone: {bussinessData[0].vendor_phone}</p></div>
//       </div>
//       <div className="mt-6 sm:mt-0 text-left sm:text-right">
//           <h4 className="!text-lg !font-bold !text-[#314158]">
//               INVOICE #{data[0].invoice_prefix}
...
//             {/* Bill To Section */}
//             <div className="mb-8">
//       <p className="text-sm text-[#45556c]">Bill To:</p>
...
//               <table className="min-w-full bg-white border border-[#cad5e2] rounded-md">
//                 <thead>
//                   <tr className="bg-[#20B2AA] text-white text-left text-sm font-semibold rounded-t-md">
//                     <th className="py-3 px-4 border-b border-[#cad5e2] rounded-tl-md">
//                       S.NO.
//                     </th>
//                     <th className="py-3 px-4 border-b border-[#cad5e2] rounded-tl-md">
...
//                   </span>
//                 </div>
//                 <div className="flex justify-between py-3 bg-[#FFD700] rounded-b-md px-4">
//                   <span className="font-bold text-lg">Grand Total:</span>
//                   <span className="font-bold text-lg">
//                     {" "}
//                     ₹ {data[0].total_amount}
...
//                       <div className="font-serif text-lg text-invoice-signature mb-2">
//                       <div
//                         className="border ml-[65%] border-b-black"
//                         style={{ width: "200px", height: "100px" }}
//                       ></div>
//                       Authorized Signature
//                     </div>
...
function handlePdf(){
  ...
  const pdf = async () => {
  try {
    const res = await apiPost('/pdf/invoice',generatePdfData);
    console.log(res);
      ...
      {data != null && bussinessData != null ? (
        <div className="flex justify-center mt-2">
          ...
          <div className="flex justify-between">
            <div></div>
            <div>
<button className="!text-[[#3A5B76]" onClick={handleDownloadPrint}><IoMdPrint className="!text-[#3A5B76] mr-3"/></button>
...
<button className="" onClick={(e)=>handleEdit(e)}><FaEdit className="!text-[#3A5B76] mr-3"/></button>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8">
              <div className="flex items-start sm:items-end">
                ...
                <div className="">
                  ...
                  {/* <p className="text-sm text-slate-600">{invoiceData.from.address}, {invoiceData.from.city} - {invoiceData.from.zip}</p> */}
                  <p className="!text-sm !text-[#314158]">
                    {bussinessData[0].gstin==null?"": "GSTIN" +":"+bussinessData[0].vendor_gstin}
                  </p>
                  <p className="!text-sm !text-[#314158]">
                     Email:{" "}
              ...
              <div className="mt-6 sm:mt-0 text-left sm:text-right">
                <h4 className="text-sm text-slate-600">Invoice Number:</h4>
                <h4 className="!text-lg !font-bold !text-[#314158]">
                  {data[0].invoice_prefix}
                </h4>
                <p className="text-sm text-[#314158]">Invoice Date: {date}</p>
                <p className="text-sm text-[#314158]">
      ...
      <p className="text-sm text-[#45556c]">{data[0].billingaddress != "  null null null"
                ? data[0].billingaddress
                   : ""}</p>
      <p className="text-sm text-[#45556c]">{data[0].gst != "" ? "GSTIN" + "-" + data[0].gst + "|" : ""}{" "}</p>       <p className="text-sm text-[#45556c]">Mobile No: {data[0].mobile_no}</p>
            </div>
      ...
      <div className="">
        <h4 className="font-semibold text-[#1d293d] mb-2 text-md">Payment Details:</h4>
        <div className="p-4 bg-[#f8fafc] rounded-md border border-[#e2e8f0]">
          <p className="text-sm text-[#1d293d]">Bank Name: {data[0].bankbranch}</p>
          <p className="text-sm text-[#1d293d]">Account No: {data[0].accountnumber}</p>
          <p className="text-sm text-[#1d293d]">IFSC Code: {data[0].accountholder}</p>
          <p className="text-sm text-[#1d293d]">UPI ID: {data[0].bankifsc}</p>
        </div>
      </div>
      <div className="flex flex-col items-end mt-10">
        <div className="w-full max-w-xs">
          <div className="flex justify-between py-2 border-b border-[#e2e8f0]">
            <span className="text-[#1d293d] text-sm">Subtotal:</span>
            <span className="font-semibold text-[#1d293d] text-sm">₹ {data[0].taxable_amount}</span>
          </div>
          <div className="flex justify-between py-2 border-b #e2e8f0">
            <span className="text-[#1d293d] text-sm">Total GST:</span>
