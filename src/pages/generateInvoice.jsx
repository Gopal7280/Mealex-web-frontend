...
export function GenerateInvoice() {
  ...
  const handleDownloadPDF = async () => {
    ...
    for (let page = 0; page < totalPages; page++) {
      ...
      pdf.setFontSize(10);
      pdf.text(
        `${page + 1}/${totalPages}-${data[0].invoice_prefix}`,
        pageWidth / 2,
        pageHeight - 5,
        {
          align: 'center',
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 sm:p-8 w-full max-w-7xl mb-12">
            <h2 className="text-2xl font-bold text-[#314158] mb-6 border-b border-[#cad5e2] pb-2">
              <div className="flex justify-between">
                ...
                <div>
                  ...
                  >
                    <IoMdPrint className="!text-[#3A5B76] mr-3" />
                  </button>
                  {!download ? (
                  ...
                  <button className="" onClick={e => handleEdit(e)}>
                    <FaEdit className="!text-[#3A5B76] mr-3" />
                  </button>
                </div>
              </div>
            </h2>
            <div className="p-4" ref={contentRef}>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8">
                <div className="flex items-start sm:items-end">
                  ...
                  <div className="">
                    ...
                    {/* <p className="text-sm text-slate-600">{invoiceData.from.address}, {invoiceData.from.city} - {invoiceData.from.zip}</p> */}
                    <p className="!text-sm !text-[#314158]">
                      {bussinessData[0].gstin == null
                        ? ''
                        : 'GSTIN' + ':' + bussinessData[0].vendor_gstin}
                    </p>
                    <p className="!text-sm !text-[#314158]">
                      Email: {bussinessData[0].vendor_email}
                    </p>
                    <p className="!text-sm !text-[#314158]">
                      Phone: {bussinessData[0].vendor_phone}
                    </p>
                  </div>
                </div>
                <div className="mt-6 sm:mt-0 text-left sm:text-right">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div className="">
                  <h4 className="font-semibold text-[#1d293d] mb-2 text-md">
                    Payment Details:
                  </h4>
                  <div className="p-4 bg-[#f8fafc] rounded-md border border-[#e2e8f0]">
                    ...
                    <p className="text-sm text-[#1d293d]">
                      IFSC Code: {data[0].accountholder}
                    </p>
                    <p className="text-sm text-[#1d293d]">
                      UPI ID: {data[0].bankifsc}
                    </p>
                  </div>
                </div>
                <div className="flex flex-col items-end mt-10">
                  <div className="w-full max-w-xs">
                    <div className="flex justify-between py-2 border-b border-[#e2e8f0]">
                      ...
                      <span className="font-semibold text-[#1d293d] text-sm">
                        ₹ {data[0].taxable_amount}
                      </span>
                    </div>
