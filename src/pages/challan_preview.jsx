...
export function ChallanPreview() {
  ...
  function fetchAmountToWord(totall){
              ...
              function handleChallanToInvoice(){
                console.log(location.state.data.challan_id);
                const challanId=location.state.data.challan_id;
                const convert=async ()=>{
          ...
          <form className="">
            ...
            <div>
                <InputComponent
                  ...
                  type="text"
                  name="customerName"
                  placeholder="Enter Challan prefix"
                  required
                  classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                />
              </div>
            ...
            <div>
                <InputComponent
                  labelName="sgst"
                  classNameLabel="block mb-2 font-semibold text-gray-700"
                  labelInput="SGST Amount:"
                  type="number"
                  name="sgst"
                  readOnly
                  value={challanData?.sgst || ''} // Use optional chaining
                  classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                />
              </div>
              <div>
                <InputComponent
                  labelName="cgst"
                  classNameLabel="block mb-2 font-semibold text-gray-700"
                  labelInput="CGST Amount:"
                  type="number"
                  name="totalAmount"
                  readOnly
                  value={challanData?.cgst || ''} // Use optional chaining
                  classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                />
              </div>
              <div>
