...
export function ChallanEdit() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      values.storeId = challanData.store_id;
      ...
      //   }
      values.bankAccountId = challanData.bank_account_id;
      values.challanNotes = notes;
  ...
  var gstSum = 0;
  const [gstSu, setGstSu] = useState("NaN"); //hui
                  ...
                  <div className="block sm:grid grid-cols-3 gap-4 border p-6 sm:h-90 h-max sm:flex justify-center items-center bg-gray-50 text-gray-500 text-lg font-medium cursor-pointer">
                    <div>
                      ...
                      <InputComponent
                        type="text"
                        name="challan_prefix"
                        value={challanData.challan_prefix}
                        readOnly
                    ...
                    <div>
                      ...
                      <InputComponent
                        type="text"
                        name="challan_number"
                        value={challanData.challan_number}
                        readOnly
                        classNameInput="w-full border p-2 rounded-lg text-gray-700 bg-gray-50 mt-2"
                        onChange={formik.handleChange} // This will not trigger since readOnly
                      />
                    ...
                    <div>
                      ...
                      <InputComponent
                        type="text"
                        name="sales_challan_date"
                        value={challanData.sales_challan_date}
                        readOnly
                        classNameInput="w-full border p-2 rounded-lg text-gray-700 bg-gray-50 mt-2"
                        onChange={formik.handleChange} // This will not trigger since readOnly
                      />
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mb-2 px-2">
                        <div className="w-42">
                          ...
                          <InputComponent
                            ...
                            id="payment_terms"
                            readOnly
                            value={challanData.payment_terms}
                 ...
                 >
                  ...
                  {gstSu != "NaN" ? (
                    ...
                    <div
                      ...
                      onChange={formik.handleChange}
                    >
                      ₹Tax Amount {challanData.tax_amount}
                    </div>
                  )}
                  <div
                    className="text-center font-semibold"
                ...
                <div>
                  ...
                  <div className="border p-6 h-60 bg-gray-50 text-gray-500 text-lg font-medium cursor-pointer">
                    ...
                    <div className="mt-1 p-2">
                      <p className="text-sm">Account Number: {challanData.accountnumber}</p>
                      <p className="text-sm">Account Holder's Name: {challanData.accountholder}</p>
                      <p className="text-sm">IFSC CODE: {challanData.bankifsc}</p>
                      <p className="text-sm">Branch Name: {challanData.bankbranch}</p>
                    </div>
                    {/* <ButtonComponent
                  type="button"
