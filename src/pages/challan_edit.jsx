                  ...
                  <div>
                    <div className="border p-6 h-60 bg-gray-50 text-gray-500 text-lg font-medium cursor-pointer">
                      ...
                      <div className="mt-1 p-2">
                        <p className="text-sm">
                          Account Number: {challanData.accountnumber}
                        </p>
                        <p className="text-sm">
                          Account Holder's Name: {challanData.accountholder}
                        </p>
                        <p className="text-sm">
                          IFSC CODE: {challanData.bankifsc}
                        </p>
                        <p className="text-sm">
                          Branch Name: {challanData.bankbranch}
                        </p>
                      </div>
                      {/* <ButtonComponent
                  type="button"
