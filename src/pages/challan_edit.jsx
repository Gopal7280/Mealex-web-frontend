...
export function ChallanEdit() {
  ...
  //       total:rate + productDetail.selling_price * parseFloat(updatedRows[index].quantity), // Update total based on quantity
  //       discount_amount: "0",
  //       discount_amountPer: "0%",
  //       taxable_amount: productDetail.selling_price * parseFloat(updatedRows[index].quantity),
  //       productDescription: "",
  //     };
  ...
  const challanData = challanPreview[0];
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      values.challanPrefix = challanData.challan_prefix;
      values.challanId = challanData.challan_id;
      values.customerId = challanData.customer_id;
      if (values.challanDate == "") {
        values.challanDate = challanPreview[0].sales_challan_date;
      }
      if (values.challanDueDate == "") {
        values.challanDueDate = challanPreview[0].due_date;
      }
      if (values.paymentTerms == "") {
        values.paymentTerms = challanPreview[0].payment_terms;
      }
      if (values.sgst == "") {
        values.sgst = challanPreview[0].sgst;
      }
      if (values.cgst == "") {
        values.cgst = challanPreview[0].cgst;
      }
      if (values.customerName == "") {
        values.customerName = challanPreview[0].customername;
      }
      if (values.billing_address == "") {
        values.billing_address = challanPreview[0].billingaddress;
      }
      if (values.shipping_address == "") {
        values.shipping_address = challanPreview[0].shippingaddress;
      }
      if (values.taxableAmount == "") {
        values.taxableAmount = challanPreview[0].taxable_amount;
      }
      if (values.totalAmount == "") {
        values.totalAmount = challanPreview[0].total_amount;
      }
      if (values.challanNotes == "") {
        values.challanNotes = challanPreview[0].add_notes;
      }
      ...
      //   }
      values.bankDetail = [
        challanPreview[0].accountholder,
        challanPreview[0].accountnumber,
        challanPreview[0].bankbranch,
        challanPreview[0].ifsccode,
      ];
      values.signature_box = challanPreview[0].signature_box;
      values.businessprofile = businessprofile;
      values.productData = productRows;
      values.cgstAmount = gstAmount != null ? gstAmount / 2 : challanData.cgst;
      values.sgstAmount = gstAmount != null ? gstAmount / 2 : challanData.sgst;
      values.taxableAmount =
        taxableAmount != null ? taxableAmount : challanData.taxable_amount;
      values.totalAmount =
        addTotal != null ? addTotal : challanData.total_amount;
      values.totalGstAmount =
        gstAmount != null ? gstAmount : challanData.tax_amount;
      values.taxAmount = TaxAmount.length > 0 ? TaxAmount : [0];
      console.log(values.cgstAmount);
      setAll(values);
      const EditChallan = async () => {
        const res = await apiPut(`/challan`, values);
        setOpen(true);
        setTimeout(() => {
  ...
  useEffect(() => {
    ...
    setChallanPreview([location.state.data]);

    const fetchProductChallan = async () => {
      const res = await apiGet(`/challan/${id}`);
      console.log(res);
      var rate = 100;
      rate = parseInt(res[0].gstrate) * parseFloat(res[0].unitprice);
      console.log(res);
      rate = rate / 100;
      console.log("gstRate" + rate);
      ...
      const updateMe = res.map((item) => 0);
      setdisabl(updateMe);
      setProductLength(updatedRows.length);
                  ...
                  <div className="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
                    <div>
                      <InputComponent
                        ...
                        {...(isEditable
                          ? {}
                          : { value: challanData.sales_challan_date })} // Use optional chaining)}
                        required
                    ...
                    <div>
                      <InputComponent
                        labelName="ChallanDate"
                        classNameLabel="block mb-2 font-semibold text-gray-700"
                        labelInput="Due Challan Date:"
                        onChange={formik.handleChange}
                        type="text"
                        name="challanDueDate"
                        placeholder="date.month.year"
                        onFocus={handleEditable}
                        {...(isEditable ? {} : { value: challanData.due_date })} // Use optional chaining)}
                        required
                        classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                      />
                    </div>
                    <div>
                      <InputComponent
                        labelName="challanPrefix"
                        classNameLabel="block mb-2 font-semibold text-gray-700"
                        labelInput="Challan Prefix:"
                        onChange={formik.handleChange}
                        type="text"
                        name="challanPrefix"
                        placeholder="challan prefix"
                        onFocus={handleEditable}
                        {...(isEditable
                          ? {}
                          : { value: challanData.challan_prefix })} // Use optional chaining)}
                        required
                        classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
                    <div>
                      ...
                      <textarea
                        ...
                        {...(isEditable
                          ? {}
                          : { value: `${challanData?.billingaddress || ""}` })}
                  ...
                  <div className="grid grid-cols-1 gap-6 mb-6 md:grid-cols-2">
                    <div>
                      <InputComponent
                        ...
                        readOnly
                        value={
                          addTotal == null ? challanData.sgst : gstAmount / 2
                        }
                        classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                      />
                    </div>
                    <div>
                      <InputComponent
                        ...
                        readOnly
                        value={
                          addTotal == null ? challanData.cgst : gstAmount / 2
                        }
                        classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                      />
                    </div>
                    ...
                    <div>
                      <InputComponent
                        ...
                        readOnly
                        value={
                          gstAmount == null ? challanData.tax_amount : gstAmount
                        }
                        classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                      />
                    </div>
                    <div>
                      <InputComponent
                        ...
                        readOnly
                        value={
                          addTotal == null ? challanData.total_amount : addTotal
                        }
                        classNameInput="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-600 hover:bg-gray-200"
                      />
                    </div>
