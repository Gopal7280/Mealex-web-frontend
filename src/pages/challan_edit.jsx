        ...
        <div>
             ...
             <h2 className="mb-6 text-3xl font-semibold text-center text-gray-800 d-inline-block">
                 Update Details
                   ...
                   <NavLink to="/deliverychallan-table" className="text-white text-decoration-none">
                    <ButtonComponent
                       type="button"
                 ...
                 >
                   QTY: {qty}
                     ...
                     <div
                       ...
                       onChange={formik.handleChange}
                     >
                       Total Amount:₹{addTotal==null?challanData.total_amount:addTotal}
                     </div>
                   </div>
                 </div>
                       ...
                       <div key={index} className="">
                         ...
                         <div className="">
                           <div className="flex justify-between">
                             ...
                             <div className="">₹{(addTotal == null ? challanData.sgst : (gstAmount / 2).toFixed(2))}</div>
                           </div>
                           <div className="flex justify-between">
                             <div className="font-medium">
                               CGST@
                             ...
                             <div>₹{(addTotal == null ? challanData.cgst : (gstAmount / 2).toFixed(2))}</div>
                           </div>
                         </div>
                       </div>
                     </div>
                   ...
                   <div className="block sm:grid grid-cols-2 gap-4 border p-6 h-max sm:flex justify-center items-center bg-gray-50 text-gray-500 text-lg font-medium cursor-pointer">
                     ...
                     <div>
                       <InputComponent
                         ...
                         value={addTotal == null ? challanData.total_amount : addTotal}
                         readOnly
                       />
                     </div>
