...
export default function LandingPage() {
  ...
  return (
   ...
   {/* <div className="pt-4 border-t mt-4">
                  <button onClick={() => navigate("/login")} className="w-full text-left py-2">Login</button>
                  <button onClick={() => navigate("/login", { state: "register" })} className="w-full text-left py-2">Sign Up</button>
                </div> */}
      {/* ===================================================================
          HERO - <<— KEPT YOUR LATEST HERO STRUCTURE — DO NOT EDIT IF YOU WANT
          (I only wrapped with 'reveal' so it animates into view too)
         =================================================================== */}
  <section
  className="relative overflow-hidden bg-white py-20 px-5 md:px-16"
  style={{
...
>
  ...
  <div className="relative max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-16 z-10">
    ...
    <div className="relative w-full md:w-1/2 flex justify-center">
      ...
      {/* ===================================================================
         MODERNIZED CONTENT AFTER HERO (features, how it works, testimonials, faq, contact)
         Bold/dynamic animations applied
         =================================================================== */}

      {/* FULL DESCRIPTION */}
      {/* <section id="full-description" className="bg-white py-16 md:py-20 px-6 reveal">
        <div className="max-w-6xl mx-auto text-center">
          <h3 className="text-3xl md:text-4xl font-extrabold mb-4 text-blue-900">MealEx is a Smart Digital Meal App</h3>
          <p className="text-base md:text-lg text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
            MealEx is a smart digital meal app designed for both customers and providers. Whether you’re a student dining at a mess or hostel canteen, a professional depending on a tiffin service, or a provider managing multiple messes, MealEx makes meal management simple, cashless, and transparent.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
            <div className="bg-gradient-to-br from-green-50 to-white p-6 rounded-2xl shadow-md reveal card-pop">
              <h4 className="font-semibold text-green-800 text-xl mb-2">For Customers</h4>
              <p className="text-gray-700">Find verified messes, buy tokens online, track subscriptions and redeem without cash.</p>
            </div>
            <div className="bg-gradient-to-br from-orange-50 to-white p-6 rounded-2xl shadow-md reveal card-pop">
              <h4 className="font-semibold text-orange-700 text-xl mb-2">For Providers</h4>
              <p className="text-gray-700">Publish plans, onboard via guided KYC, and track settlements & redemptions from one dashboard.</p>
            </div>
          </div>
        </div>
      </section> */}
...
>
  ...
  <div className="max-w-6xl mx-auto text-center">
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-6">
      ...
      {/* OWNERS */}
      {/* <section id="owners" className="py-16 px-6 bg-white reveal">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div className="order-2 md:order-1 reveal">
            <img src={odash} alt="mealex owner dashboard preview" className="md:rounded-xl  w-lg max-w-lg" />
          </div>
          <div className="order-1 md:order-2 space-y-6">
            <h3 className="text-3xl md:text-4xl font-extrabold text-orange-600">For Mess Owners</h3>
            <p className="text-gray-700">List meal plans, get paid digitally, and view settlements — all from one modern dashboard.</p>
            <ul className="list-disc pl-5 text-gray-700 space-y-2">
              <li>Fast, guided KYC & bank setup</li>
              <li>Plan & pricing management</li>
              <li>Customer & subscription tracking</li>
...
{/* owners section  */}
      ...
      {/* <section id="owners" className="py-16 px-6 bg-white reveal">
  <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
    <div className="order-2 md:order-1 reveal flex justify-center">
      <img
        src={odash}
        alt="mealex owner dashboard preview"
        className="rounded-xl w-full max-w-md sm:max-w-lg md:max-w-xl h-auto object-contain"
      />
    </div>
    ...
    <div className="order-1 md:order-2 space-y-6 text-center md:text-left">
      ...
      {/* CUSTOMERS */}
      {/* <section id="customers" className="bg-gray-50 py-16 px-6 reveal">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          <div className="flex justify-center">
            <img src={cdash} alt="mealex customer journey" className="rounded-2xl  w-lg max-w-lg" />
          </div>
          <div>
            <h3 className="text-3xl md:text-4xl font-extrabold text-blue-800">For Customers</h3>
            <p className="text-gray-700 mb-4">Search mess halls, view plans, buy tokens, and redeem easily using MealEx.</p>
            <ul className="list-disc pl-5 text-gray-700 space-y-2">
              <li>Find verified messes nearby</li>
              <li>Transparent plan information</li>
              <li>Secure subscription flow</li>
            ...
            <div className="mt-6">
              <button onClick={() => navigate("/login")} className="bg-orange-500 text-white px-6 py-3 rounded-lg shadow-md hover:bg-orange-400 transition font-semibold">Explore on Web</button>
            </div>
          </div>
        </div>
      </section> */}
  {/* customers section hai niche */}
  ...
  <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
    <div className="flex justify-center order-2 md:order-1">
      <img
        src={cdash}
        alt="mealex customer journey"
        className="rounded-2xl w-full max-w-md sm:max-w-lg md:max-w-xl h-auto object-contain"
      />
    </div>
    ...
    <div className="order-1 md:order-2 text-center md:text-left space-y-6">
      ...
      {/* OWNERS ↔ CUSTOMERS SECTION (SLIDES) */}
{/* <section
  id="owners-customers"
...
>
  ...
  >
    <div className="flex-shrink-0 w-full snap-center px-4">
      <div className="slide-box bg-gradient-to-br from-orange-50 via-white to-orange-100">
        <div className="grid md:grid-cols-2 gap-10 items-center h-full">
          <div className="order-2 md:order-1 flex justify-center">
            <img
              src={odash}
              alt="mealex owner dashboard"
    ...
    <div className="flex-shrink-0 w-full snap-center px-4">
      <div className="slide-box bg-gradient-to-br from-green-50 via-white to-green-100">
        <div className="grid md:grid-cols-2 gap-10 items-center h-full">
          <div className="flex justify-center order-2 md:order-1">
            <img
              src={cdash}
...
>
  ...
  >
    ...
    <div className="flex-shrink-0 w-full snap-center px-4 fade-slide">
...
<style>
  ...
  `}
      ...
      {/* STRONG FEATURE GRID */}
      {/* <section id="features" className="py-16 px-6 bg-white reveal">
        <div className="max-w-7xl mx-auto text-center mb-8">
          <h3 className="text-3xl md:text-4xl font-extrabold text-green-800">Key Features</h3>
          <p className="text-gray-600 mt-2 max-w-2xl mx-auto">Powerful tools for owners and customers — built with Indian messes in mind.</p>
        </div>

        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {[
            { icon: "📍", title: "Mess Discovery", description: "Search and explore verified messes & tiffin services nearby with clear details." },
            { icon: "📝", title: "Simple Subscriptions", description: "Subscribe to a mess plan on the web. Transparent pricing and flexible durations." },
            { icon: "✅", title: "Owner KYC Onboarding", description: "Guided, paperless KYC & bank setup for mess owners." },
            { icon: "🔐", title: "Secure Payouts", description: "Bank details & settlements handled with industry-grade security." },
            { icon: "📊", title: "Owner Dashboard", description: "Manage plans, customers, and settlements from a clean web dashboard." },
            { icon: "⚡", title: "Online Payments", description: "Seamless online payments for subscriptions." },
          ].map((f, i) => (
            <div key={i} className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 text-left reveal card-pop">
              <div className="flex items-center gap-4 mb-3">
                <div className="text-3xl">{f.icon}</div>
                <h4 className="text-xl font-semibold text-blue-900">{f.title}</h4>
              </div>
...
>
  ...
  <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
    {[
      ...
      {/* <section id="how-it-works" className="py-16 px-6 bg-white reveal">
        <div className="max-w-6xl mx-auto text-center mb-8">
          <h3 className="text-3xl md:text-4xl font-extrabold text-blue-900">How MealEx Works</h3>
        </div>

        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            <h4 className="text-2xl font-bold text-green-800 mb-4">For Mess Owners</h4>
            <div className="space-y-4">
              {[ "Register", "Complete KYC", "Publish Plans", "Manage & Settle" ].map((t, idx) => (
                <div key={t} className="flex items-start gap-4 reveal">
                  <div className="min-w-[46px] min-h-[46px] rounded-full flex items-center justify-center bg-orange-500 text-white font-bold text-lg">{idx+1}</div>
                  <div>
                    <h5 className="font-semibold text-blue-900 mb-1">{t}</h5>
                    <p className="text-gray-600 text-sm">{[
                      "Create your owner account on MealEx.",
                      "Finish web-based KYC & add bank details.",
                      "Create subscription plans & go live.",
                      "Track subscriptions, settlements & growth."
                    ][idx]}</p>
                  </div>
                </div>
              ))}
          ...
          <div>
            <h4 className="text-2xl font-bold text-orange-600 mb-4">For Customers</h4>
            <div className="space-y-4">
              {[ "Explore", "Choose a Plan", "Subscribe Online", "Enjoy Your Meals" ].map((t, idx) => (
                <div key={t} className="flex items-start gap-4 reveal">
                  <div className="min-w-[46px] min-h-[46px] rounded-full flex items-center justify-center bg-green-600 text-white font-bold text-lg">{idx+1}</div>
                  <div>
                    <h5 className="font-semibold text-blue-900 mb-1">{t}</h5>
                    <p className="text-gray-600 text-sm">{[
                      "Find messes near you with transparent info.",
                      "Pick what fits your routine & budget.",
                      "Pay securely (online payments coming soon).",
                      "Simple, reliable, and organized dining."
                    ][idx]}</p>
                  </div>
                </div>
              ))}
...
>
  ...
  `}</style>
      ...
      {/* <section id="faq" className="py-16 px-6 bg-white reveal">
        <div className="max-w-4xl mx-auto">
          <h3 className="text-3xl md:text-4xl font-extrabold text-center text-blue-900 mb-8">Frequently Asked Questions</h3>
          <div className="space-y-4">
            {[
              { q: "mealex mess owners ke liye kaise kaam karta hai?", a: "mealex aapko web par digital presence, guided KYC, plan publishing aur customer subscriptions manage karne mein madad karta hai." },
              { q: "Kya online payments available hain?", a: "Online payments jald aa rahe hain. Tab tak aap sign-ups collect karke customers ko onboard kar sakte hain." },
              { q: "Regional language support?", a: "Haan, multi-language support roadmap mein hai. Rollout ke sath hum announce karenge." },
              { q: "Data security kaisi hai?", a: "Bank & KYC details industry-standard practices se handle ki jati hain. Security aur privacy hamari priority hai." }
            ].map((f, i) => (
              <FAQItem key={i} question={f.q} answer={f.a} />
            ))}
          </div>
          ...
          <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
            <div className="grid md:grid-cols-2 gap-6">
              <div className="flex flex-col justify-center">
                ...
                <p className="text-gray-600 mb-4">Have questions or want to onboard your mess? Send a quick message or request a demo.</p>
              ...
              <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                <input type="text" placeholder="Your Name" className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-200" />
                <input type="email" placeholder="Your Email" className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-200" />
                <textarea rows="4" placeholder="How can we help?" className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-200" />
                <button type="submit" className="w-full bg-blue-900 text-white px-6 py-3 cursor-pointer rounded-lg font-semibold hover:bg-blue-800 transition">Send Message</button>
              </form>
            </div>
          </div>
        </div>
...
// /**
//  * LandingPage (Framer Motion polished)
//  * - Uses Framer Motion for smooth X/Y directional reveals and hover micro-interactions
//  * - Strong visual separation for Owners vs Customers with mirrored layout
//  * - Minimal content changes — mostly design, spacing, and animation
//  */
...
//   // small helper to close mobile menu when route changes
//   useEffect(() => {
...
//         <div className="max-w-7xl mx-auto px-6 md:px-8 py-4 md:py-5 flex items-center justify-between">
//           <div className="flex items-center gap-4">
//             <img src={logo} alt="MealEx Logo" className="h-7 md:h-9" />
//             <span className="hidden md:inline text-sm text-gray-600">Smart Digital Meals</span>
//           </div>
...
//             <button
//               onClick={() => navigate("/login")}
//               className="py-2 px-5 border border-[#ff5c0b] text-gray rounded-lg hover:bg-orange-50 transition shadow-sm"
//             >
//               Login
//             </button>
//             <button
//               onClick={() => navigate("/login", { state: "register" })}
//               className="py-2 px-5 bg-[#ff5c0b] text-white rounded-lg hover:bg-[#e4500b] transition shadow-sm"
//             >
//               Get Started
//             </button>
//           </div>
...
//             <button
//               onClick={() => navigate("/login", { state: "register" })}
//               className="border border-[#ff5c0b] text-[#ff5c0b] text-sm font-medium px-3 py-2 rounded-lg hover:bg-[#fff3ea] transition"
//             >
//               Register
//             </button>
//             <button
...
//         className="relative overflow-hidden bg-white py-20 px-5 md:px-16"
//         style={{
//           backgroundImage: "url('https://mrac-arts.com/wp-content/uploads/2021/12/wavy-orange-gradient-lines.png')",
//           backgroundSize: "cover",
//           backgroundPosition: "center",
//         }}
//       >
//         <div className="absolute -top-16 -left-16 w-64 h-64 bg-orange-200 rounded-full opacity-30 blur-3xl pulse-slow z-0"></div>
//         <div className="absolute -bottom-20 -right-20 w-72 h-72 bg-orange-200 rounded-full opacity-30 blur-3xl pulse-slow z-0"></div>

//         <div className="relative max-w-7xl mx-auto flex flex-col-reverse md:flex-row items-center justify-between gap-10 md:gap-16 z-10">
//           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="flex flex-col items-center md:items-start text-center md:text-left gap-6 md:gap-10 md:w-1/2">
//             <h1 className="text-4xl sm:text-5xl md:text-6xl font-semibold text-gray-800 leading-tight">
//               Your Digital <span className="bg-clip-text text-transparent font-extrabold bg-gradient-to-r from-orange-400 to-orange-600">Meal</span> Management <span className="bg-clip-text text-transparent font-extrabold bg-gradient-to-r from-green-500 to-green-600">Solution!</span>
//             </h1>
...
//             <div className="flex flex-wrap justify-center md:justify-start items-center gap-4">
//               <a href="https://play.google.com/store/apps/details?id=com.mealex&hl=en" target="_blank" rel="noopener noreferrer" className="transition-transform duration-200 hover:scale-110">
//                 <img alt="App Download Logo" className="h-10 sm:h-12 object-contain" src="https://b.zmtcdn.com/data/o2_assets/aad864bd17860b27634fe621001c32db1739350431.png" loading="lazy" />
//               </a>

//               <div className="grayscale opacity-20 cursor-not-allowed">
//                 <img alt="App Store (Coming Soon)" className="h-10 sm:h-12 object-contain" src="https://b.zmtcdn.com/data/o2_assets/df6464de32f4a09262cee301f65aaa661739351256.png" loading="lazy" />
//               </div>
//             </div>

//             <div className="mt-8 flex flex-wrap justify-center md:justify-start gap-3">
//               {["Cashless", "Transparent", "Simple", "Scalable"].map((f, i) => (
//                 <span key={i} className="px-4 py-2 rounded-full font-semibold bg-white text-orange-700 shadow-sm border-2 text-sm sm:text-base">{f}</span>
//               ))}
//             </div>
//           </motion.div>

//           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideInRight(0.12)} className="relative w-full md:w-1/2 flex justify-center">
//             <div className="relative group w-full sm:w-4/5 md:w-auto transform transition-transform hover:-translate-y-2">
//               <a href="https://www.youtube.com/embed/EtENQieKn_k?rel=0&autoplay=1&html5=1" target="_blank" rel="noopener noreferrer" className="block">
//                 <img src="https://i.ibb.co/8482r29Z/COVER.png" alt="How it works video" className="rounded-xl shadow-2xl transition-transform duration-300 w-full" />
//                 <div className="absolute inset-0 flex flex-col items-center justify-center bg-black/70 rounded-2xl opacity-0 group-hover:opacity-100 transition">
//                   <div className="flex items-center gap-2 text-white text-base sm:text-lg font-semibold">
//                     <img src="https://www.freeiconspng.com/uploads/play-button-icon-png-27.png" alt="play" className="w-8 sm:w-10" />
//                     <span>How it works ?</span>
//                   </div>
//                 </div>
//               </a>
...
//       {/* FULL DESCRIPTION */}
//       <motion.section id="full-description" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="bg-white py-16 md:py-20 px-6">
//         <div className="max-w-6xl mx-auto text-center">
//           <h3 className="text-3xl md:text-4xl font-extrabold mb-4 text-blue-900">MealEx is a Smart Digital Meal App</h3>
//           <p className="text-base md:text-lg text-gray-700 mb-8 leading-relaxed max-w-3xl mx-auto">
//             MealEx is a smart digital meal app designed for both customers and providers. Whether you’re a student dining at a mess or hostel canteen, a professional depending on a tiffin service, or a provider managing multiple messes, MealEx makes meal management simple, cashless, and transparent.
...
//           <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
//             <motion.div whileHover={{ scale: 1.02 }} className="bg-gradient-to-br from-green-50 to-white p-6 rounded-2xl shadow-md card-pop">
//               <h4 className="font-semibold text-green-800 text-xl mb-2">For Customers</h4>
//               <p className="text-gray-700">Find verified messes, buy tokens online, track subscriptions and redeem without cash.</p>
//             </motion.div>
//             <motion.div whileHover={{ scale: 1.02 }} className="bg-gradient-to-br from-orange-50 to-white p-6 rounded-2xl shadow-md card-pop">
//               <h4 className="font-semibold text-orange-700 text-xl mb-2">For Providers</h4>
//               <p className="text-gray-700">Publish plans, onboard via guided KYC, and track settlements & redemptions from one dashboard.</p>
//             </motion.div>
//           </div>
...
//       {/* OWNERS - mirrored layout with X-direction flow */}
//       <section id="owners" className="py-16 px-6 bg-white">
//         <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
//           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideInLeft(0.05)} className="order-2 md:order-1">
//             <div className="relative overflow-hidden rounded-2xl">
//               <img src={odash} alt="mealex owner dashboard preview" className="md:rounded-xl w-full object-cover transform transition-transform hover:scale-105" />
//               <div className="absolute left-6 bottom-6 bg-white/90 backdrop-blur-sm p-4 rounded-xl shadow-lg border">
//                 <p className="text-sm text-gray-700 font-semibold">Owner Dashboard Preview</p>
//               </div>
//             </div>
//           </motion.div>

//           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideInRight(0.08)} className="order-1 md:order-2 space-y-6">
//             <h3 className="text-3xl md:text-4xl font-extrabold text-orange-600">For Mess Owners</h3>
//             <p className="text-gray-700">List meal plans, get paid digitally, and view settlements — all from one modern dashboard.</p>
//             <ul className="list-disc pl-5 text-gray-700 space-y-2">
//               <li>Fast, guided KYC & bank setup</li>
...
//             <div className="flex gap-3 mt-4">
//               <motion.button whileTap={{ scale: 0.98 }} onClick={() => navigate("/login", { state: "register" })} className="bg-green-700 text-white px-6 py-3 rounded-lg shadow-md hover:bg-green-600 transition font-semibold">Get Early Access</motion.button>
//               <button onClick={() => scrollToSection("contact")} className="border border-green-700 text-green-700 px-6 py-3 rounded-lg hover:bg-green-50 transition font-semibold">Talk to Us</button>
//             </div>
//           </motion.div>
//         </div>
...
//       {/* CUSTOMERS - mirrored counterpart with X-direction animation */}
//       <section id="customers" className="bg-gray-50 py-16 px-6">
//         <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-10 items-center">
//           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideInLeft(0.06)} className="flex justify-center">
//             <div className="relative overflow-hidden rounded-2xl">
//               <img src={cdash} alt="mealex customer journey" className="rounded-2xl w-full object-cover transform transition-transform hover:scale-105" />
//               <div className="absolute right-6 top-6 bg-white/90 backdrop-blur-sm p-3 rounded-xl shadow-md border">
//                 <p className="text-sm text-gray-700 font-semibold">Customer Journey</p>
//               </div>
//             </div>
//           </motion.div>

//           <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={slideInRight(0.07)}>
//             <h3 className="text-3xl md:text-4xl font-extrabold text-blue-800">For Customers</h3>
//             <p className="text-gray-700 mb-4">Search mess halls, view plans, buy tokens, and redeem easily using MealEx.</p>
//             <ul className="list-disc pl-5 text-gray-700 space-y-2">
//               <li>Find verified messes nearby</li>
...
//       {/* FEATURES GRID */}
//       <motion.section id="features" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="py-16 px-6 bg-white">
//         <div className="max-w-7xl mx-auto text-center mb-8">
//           <h3 className="text-3xl md:text-4xl font-extrabold text-green-800">Key Features</h3>
//           <p className="text-gray-600 mt-2 max-w-2xl mx-auto">Powerful tools for owners and customers — built with Indian messes in mind.</p>
//         </div>
...
//             { icon: "⚡", title: "Online Payments", description: "Seamless online payments for subscriptions." },
//           ].map((f, i) => (
//             <motion.div key={i} whileHover={{ y: -6 }} className="bg-white p-6 rounded-2xl shadow-md border border-gray-100 text-left">
//               <div className="flex items-center gap-4 mb-3">
//                 <div className="text-3xl">{f.icon}</div>
//                 <h4 className="text-xl font-semibold text-blue-900">{f.title}</h4>
//               </div>
...
//       {/* HOW IT WORKS */}
//       <motion.section id="how-it-works" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="py-16 px-6 bg-white">
//         <div className="max-w-6xl mx-auto text-center mb-8">
//           <h3 className="text-3xl md:text-4xl font-extrabold text-blue-900">How MealEx Works</h3>
//         </div>
...
//       {/* FAQ */}
//       <motion.section id="faq" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="py-16 px-6 bg-white">
//         <div className="max-w-4xl mx-auto">
//           <h3 className="text-3xl md:text-4xl font-extrabold text-center text-blue-900 mb-8">Frequently Asked Questions</h3>
...
//       {/* CONTACT */}
//       <motion.section id="contact" initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} className="py-16 px-6 bg-gray-50">
//         <div className="max-w-4xl mx-auto">
//           <div className="bg-white p-8 rounded-2xl shadow-xl border border-gray-100">
//             <div className="grid md:grid-cols-2 gap-6">
//               <div className="flex flex-col justify-center">
...
//                 <input type="email" placeholder="Your Email" className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-200" />
//                 <textarea rows="4" placeholder="How can we help?" className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-200" />
//                 <button type="submit" className="w-full bg-blue-900 text-white px-6 py-3 rounded-lg font-semibold hover:bg-blue-800 transition">Send Message</button>
//               </form>
//             </div>
//           </div>
//         </div>
...
//   const [isOpen, setIsOpen] = useState(false);
//   return (
//     <motion.div initial={{ opacity: 0, y: 18 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="border border-gray-200 rounded-xl shadow-sm bg-white overflow-hidden">
//       <button className="flex justify-between items-center w-full p-6 text-left font-semibold text-lg text-gray-800" onClick={() => setIsOpen(!isOpen)}>
//         <span>{question}</span>
//         <span className={`text-blue-600 text-2xl transform transition-transform ${isOpen ? "rotate-45" : "rotate-0"}`}>+</span>
//       </button>
//       {isOpen && <p className="px-6 pb-6 text-gray-600 leading-relaxed">{answer}</p>}
//     </motion.div>
//   );
