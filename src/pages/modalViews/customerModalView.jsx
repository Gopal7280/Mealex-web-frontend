...
import { apiReuestLoadState } from "../../services/apiServicesOnline";
  ...
  return (
    <>
    {
      loader?(
        ...
        <Dialog header="Add Party" visible={true} className="sm:w-10/12" onHide={() => {if (!setModalShow) return; setModalShow(false); }}>
                 <div>
