...
export function ChallanForm() {
  ...
  //   }
  // };
  // function handleChange1(updatedRows,index){
  //     var amount=0;
  //     var amount1Taxable=0;
  //     console.log(index);
  //     const update1=[...updatedRows];
  //     update1[index]={
  //       ...update1[index],
  //       quantity:"0",
  //       discount_amount:"0",
  //       discount_amountPer:"0.00",
  //       total:0,
  //     }
  //     const update2=[...productAmount];
  //     update2[index].amount="0",
  //     update2[index].amount="0";

  //     for(var i of update1)
  //     {
  //       amount=amount+i.total;
  //       amount1Taxable=amount1Taxable+i.taxable_amount;

  //     }
  //     setTaxableAmount(amount1Taxable);
  //     setAddTotal(amount);
  //     console.log(amount);
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      ...
      values.due_date = challanDueDate;
  ...
  //       const a2 =
  //         (updatedRows[index].quantity * updatedRows[index].unitPrice * spl1) /
  //         100;
  ...
  //     updatedRows[index].discount_amountPer=updatedRows[index].discount_amountPer+"_%";
  //     console.log(quantity);
  //     updateDiscountAmount[index].amount=(parseFloat(updateDiscountAmount[index].per)*(updatedRows[index].quantity)*(updatedRows[index].unitPrice))/100;
  //     console.log(updateDiscountAmount);
  //     const spl=updatedRows[index].discount_amountPer.split("_");
  //     const spl1=spl[0];
  //     console.log(spl1);
  ...
  //         updatedRows[k].discount_amount="0",
  //         updatedRows[k].discount_amountPer="0"
  //         updatedProductAmount[k].amount="0"
  //         updatedProductAmount[k].per="0"
  //       }
  //     }
          ...
          <div className="over bg-gray-100 p-4 max-w-7xl mx-auto bg-white">
            ...
            <form onSubmit={formik.handleSubmit}>
              ...
              <div>
                <InputComponent
                  type="number"
                  classNameInput="w-96 p-2 bg-white border rounded-lg border-gray-300"
