...
export function GenerateChallan() {
  ...
  const invoiceData = {
    ...
    items: [
      ...
      {
        description: 'UI/UX Design Consultation (10 hours)',
        hsnSac: '998314',
        quantity: 10,
        unitPrice: 2500,
        gstRate: 18,
  ...
  useEffect(() => {
    try {
      ...
      const id = location.state?.data[0]?.challan_id; // Use optional chaining
      console.log(number);
      console.log(id);
      console.log(location.state.data);
  ...
  const handleDownloadPDF = async () => {
    ...
    for (let page = 0; page < totalPages; page++) {
      ...
      pdf.setFontSize(10);
      pdf.text(
        `${page + 1}/${totalPages}-${data[0].challan_prefix}`,
        pageWidth / 2,
        pageHeight - 5,
        {
          align: 'center',
  ...
  function handleChallanToInvoice() {
    ...
    const convert = async () => {
      const res = await apiPost(
        `/invoices/convert/challan/invoice/${challanId}`
      );
          ...
          <div className="bg-white rounded-lg shadow-xl p-6 sm:p-8 w-full max-w-7xl mb-12">
            <h2 className="text-2xl font-bold text-[#314158] mb-6 border-b border-[#cad5e2] pb-2">
              <div className="flex justify-between">
                <div></div>
                <div>
                  <button className="" onClick={handleDownloadPrint}>
            ...
            <div className="p-4" ref={contentRef}>
              ...
              <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8">
                ...
                <div className="mt-6 sm:mt-0 text-left sm:text-right">
                  <h4 className="text-sm text-slate-600">Challan Number:</h4>
                  <h4 className="!text-lg !font-bold !text-[#314158]">
                    {data[0].challan_prefix}
                  </h4>
                  <p className="text-sm text-[#314158]">Challan Date: {date}</p>
                  <p className="text-sm text-[#314158]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
                <div>
                  <h4 className="font-semibold text-slate-800 mb-2 text-md">
                    Payment Details:
                  </h4>
