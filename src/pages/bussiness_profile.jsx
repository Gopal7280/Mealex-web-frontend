...
import { apiReuestLoadCountry, apiReuestLoadState } from "../services/apiServicesOnline";
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <InputComponent
                      ...
                      classNameInput="w-full p-2 border rounded mt-1"
                      onChange={formik.handleChange}
                      {...(edit ? {} : { value: data[0].vendor_business_legal_name })}
                    />
                  </div>
                  <div>
                    <InputComponent
                  ...
                  <div>
                            ...
                            >
                                <option disabled value="">{data[0].vendor_industry_type!=""?data[0].vendor_industry_type:"select"}</option>
                      ...
                      {...(edit ? {} : { value: data[0].vendor_gstin })}
                                className="w-full p-2 border rounded mt-1"
                                value={formik.values.vendor_business_category}
                            >
                                <option disabled value="">{data[0].vendor_business_category!=""?data[0].vendor_business_category:"select"}</option>
