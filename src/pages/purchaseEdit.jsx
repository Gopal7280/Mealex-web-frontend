...
export function PurchaseEdit() {
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      values.storeId=purchaseData.store_id;
  ...
  function handleRoundChange(e) {
    if (e.target.checked && addTotal!=null) {
      ...
      setRound(roundedofValue.toFixed(2));
        ...
        originalValue=purchaseData.total_amount;
       roundValue=Math.round(purchaseData.total_amount);
      console.log(originalValue);
      console.log(roundValue);
              ...
              <div className="block sm:grid grid-cols-3 gap-4 border p-6 sm:h-90 h-max sm:flex justify-center items-center bg-gray-50 text-gray-500 text-lg font-medium cursor-pointer">
                <div>
                  ...
                  <InputComponent
                    ...
                    value={purchaseData.purchase_prefix}
                    readOnly
                ...
                <div>
                  ...
                  <InputComponent
                    ...
                    {...(purchaseData.original_invoice_number!="")?{value:purchaseData.original_invoice_number}:{}}
                    readOnly
                    classNameInput="w-full border p-2 rounded-lg text-gray-700 bg-gray-50 mt-2"
                    onChange={formik.handleChange} // This will not trigger since readOnly
                  />
            ...
            QTY: {qty}
              ...
              {gstSu != "NaN" ? (
                ...
                <div
                  ...
                  onChange={formik.handleChange}
                >
                  ₹Tax Amount {purchaseData.tax_amount}
                </div>
              )}
              <div
                className="text-center font-semibold"
                ...
                onChange={formik.handleChange}
              >
                Total Amount:₹{addTotal==null?purchaseData.total_amount:addTotal}
              </div>
            </div>
          </div>
                ...
                <div key={index} className="">
                  ...
                  <div className="">
                    <div className="flex justify-between">
                      ...
                      <div className="">₹{(addTotal == null ? purchaseData.sgst : (gstAmount / 2).toFixed(2))}</div>
                    </div>
                    <div className="flex justify-between">
                      <div className="font-medium">
                        CGST@
                      ...
                      <div>₹{(addTotal == null ? purchaseData.cgst : (gstAmount / 2).toFixed(2))}</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="block sm:grid grid-cols-2 gap-4 border p-6 h-max sm:flex justify-center items-center bg-gray-50 text-gray-500 text-lg font-medium cursor-pointer">
              ...
              <div>
                <InputComponent
                  ...
                  value={addTotal == null ? purchaseData.total_amount : addTotal}
                  readOnly
                />
              </div>
