...
//           <div className="flex gap-6 mb-6 border-b pb-1">
//             <button
//               onClick={() => navigate('/owner-customer-profile')}
//               className={`capitalize cursor-pointer text-md font-medium ${currentPath === '/customer-profile' ? 'text-orange-600 border-b-2 border-orange-500' : 'opacity-50 hover:opacity-80'}`}
//             >
//               {t("profile")}
//             </button>
//             <button
//               onClick={() => navigate('/customer-profile/plans')}
//               className={`capitalize cursor-pointer text-md font-medium ${currentPath === '/customer-profile/plans' ? 'text-orange-600 border-b-2 border-orange-500' : 'opacity-50 hover:opacity-80'}`}
//             >
//               {t("plans")}
//             </button>
//             <button
//               onClick={() => navigate('/customer-profile/history')}
//               className={`capitalize cursor-pointer text-md font-medium ${currentPath === '/customer-profile/history' ? 'text-orange-600 border-b-2 border-orange-500' : 'opacity-50 hover:opacity-80'}`}
//             >
//               {t("history")}
//             </button>
//           </div>
...
//                   <th className="py-3 px-4">{t("tokens")}</th>
...
//                       <td className="py-2 px-4">
//                         {entry.type === 'Used'
//                           ? (entry.submittedTokens?.length || 0)
//                           : (entry.tokensPurchased || 0)}
//                       </td>
//                       <td className="py-2 px-4">
...
//                           entry.type === 'Purchased' ? 'text-green-600' : 'text-red-600'
//                         }`}
//                       >
//                         {t(entry.type)}
//                       </td>
