  ...
  const openPdfInNewTab = () => {
    ...
    <div className="sm:grid block grid-cols-2 mt-2 border p-6 sm:flex justify-center items-center bg-gray-50 text-gray-500 text-lg font-medium cursor-pointer">
        ...
        <div className="flex justify-between">
            ...
            <h6>{businessprofile.length>0?(businessprofile[0].business_name):""}</h6>
          </div>
          <div>
          <h6>{businessprofile.length>0?(businessprofile[0].mobile_no):""}</h6>
            <h6>{businessprofile.length>0?(businessprofile[0].pan_no):""}</h6>
            <h6>{businessprofile.length>0?(businessprofile[0].gst):""}</h6>
          </div>
          </div>
