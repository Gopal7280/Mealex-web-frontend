  ...
  return (
    ...
    <div className="over max-w-6xl mx-auto bg-white p-8 shadow-lg rounded-md">
      ...
      <form id="paymentInForm" onSubmit={formik.handleSubmit}>
        ...
        <div>
          <div><label htmlFor="invoiceId" className="block text-gray-600 mt-4">Invoice Id:</label></div>
        <Dropdown  onChange={(e)=>handleInvoiceChange(e,e.value)}  value={invoiceId} options={selectedInvoiceId} optionLabel="name" 
                editable placeholder="Select a Invoice id" className="w-full mt-1 md:w-14rem" />
        </div>
        <div>
        <InputComponent
                htmlFor="amount"
