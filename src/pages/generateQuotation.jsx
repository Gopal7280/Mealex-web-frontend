...
export function GenerateQuotationn() {
  ...
  const quotationData = {
    ...
    terms: 'Payment is due within 30 days of the quotation date. Late payments may incur a 2% monthly interest charge.',
  };
  useEffect(() => {
    try {
      const dt = new Date();
...
<button className="" onClick={(e)=>handleEdit(e)}><FaEdit className="!text-[#3A5B76] mr-3"/></button>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end mb-8">
              <div className="flex items-start sm:items-end">
                ...
                <div className="">
                  ...
                  {/* <p className="text-sm text-slate-600">{quotationData.from.address}, {quotationData.from.city} - {quotationData.from.zip}</p> */}
              ...
              <div className="mt-6 sm:mt-0 text-left sm:text-right">
                <h4 className="text-sm text-slate-600">Quotation Number:</h4>
                <h4 className="!text-lg !font-bold !text-[#314158]">
                  {data[0].quotation_prefix}
                </h4>
                <p className="text-sm text-[#314158]">Quotation Date: {date}</p>
                <p className="text-sm text-[#314158]">
      ...
      <div>
        ...
        <div className="p-4 bg-[#f8fafc] rounded-md border border-[#e2e8f0]">
          <p className="text-sm text-[#45556c]">Bank Name: {data[0].bankbranch}</p>
          <p className="text-sm text-[#45556c]">Account No: {data[0].accountnumber}</p>
          <p className="text-sm text-[#45556c]">IFSC Code: {data[0].accountholder}</p>
          <p className="text-sm text-[#45556c]">UPI ID: {data[0].bankifsc}</p>
        </div>
      </div>
      <div className="flex flex-col items-end mt-10">
        <div className="w-full max-w-xs">
          <div className="flex justify-between py-2 border-b border-[#e2e8f0]">
            <span className="text-[#45556c] text-sm">Subtotal:</span>
            <span className="font-semibold text-[#1d293d] text-sm">₹ {data[0].taxable_amount}</span>
          </div>
          <div className="flex justify-between py-2 border-b border-[#e2e8f0]">
            <span className="text-[#45556c] text-sm">Total GST:</span>
          ...
          <div className="flex justify-between py-3 bg-[#FFD700] text-[#1d293d] rounded-b-md px-4">
            ...
            <div className="flex justify-between mb-4">
              <div className="w-1/2">
                <div className="mt-6">
                  <div>
                    <div className="font-serif text-lg text-quotation-signature mb-2">
                      <div
